...
// Función para realizar la inferencia y descargar los datos en formato CSV
var inferAndDownloadCSV = function() {
    ...
    getSettingsFromForm(function(settings) {
        ...
        .done(function(response) {
            ...
            if (response && response.length > 0) {
                ...
                // Codifica el contenido CSV en un enlace de descarga
                ...
                // Simula el clic en el enlace para iniciar la descarga del archivo CSV
                ...
                $('#output').html("Error: No se pudo obtener una respuesta válida del servidor.");
            }
        })
        .fail(function(xhr, textStatus, errorThrown) {
            console.error("AJAX Error:", textStatus, errorThrown); // Depurar cualquier error de AJAX
            $('#output').html("Error: Failed to load response. Please try again.");
        });
    });
};
